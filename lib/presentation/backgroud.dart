...
void callbackDispatcher() {
  Workmanager().executeTask((task, inputData) async {
    ...
    final locationAlwaysGranted = await Permission.locationAlways.status.isGranted;
    final bindingOptions = BindingOptions(locationAlwaysGranted: locationAlwaysGranted);
    InitialBindings(bindingOptions).dependencies();
